...
const AllRestaurants = () => {
  ...
  const getRestaurants = () => {
    ...
    return restaurants.map((restaurant) => ({
      ...
      menuCount: restaurant.menu ? restaurant.menu.length : 0, // dishes from menu
        ...
        <div className="flex items-center justify-center min-h-screen px-4">
          <div className="text-center">
            ...
            <h3 className="text-xl font-medium mb-2">
              Unable to Finding your next meal spot...
            </h3>
            <p
              className={`mb-4 ${
        ...
        <div className="flex flex-col space-y-4 sm:flex-row sm:items-center sm:justify-between sm:space-y-0 mb-6 sm:mb-8">
          <div className="flex items-start space-x-3 min-w-0 flex-1">
            ...
            <div className="min-w-0 flex-1">
              ...
              >
                Discover Finding your next meal spots near you...
              </p>
            </div>
          </div>
          ...
          <div className="flex items-center justify-start sm:justify-center space-x-4 sm:space-x-6 flex-shrink-0">
            <div className="flex items-center space-x-2">
              <div className="p-1.5 sm:p-2 bg-gradient-to-r from-green-500 to-green-500 rounded-lg">
            ...
            <div className="flex items-center space-x-2">
              <div className="p-1.5 sm:p-2 bg-gradient-to-r from-red-500 to-yellow-500 rounded-lg">
